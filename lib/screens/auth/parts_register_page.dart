...
class PartsRegisterPage extends StatefulWidget {
  const PartsRegisterPage({super.key});

  @override
  State<PartsRegisterPage> createState() => _PartsRegisterPageState();
}

class _PartsRegisterPageState extends State<PartsRegisterPage> {
  ...
  // Step 2 Data
  final Map<String, bool> _partTypes = {
    'Engine Parts': false,
    'Brake System': false,
    'Suspension': false,
    'Electrical': false,
  ...
  Widget _buildStep1() {
    return Column(
      ...
      children: [
              ...
              Container(
                ...
                child: ClipOval(
                  child: _logoImage != null 
                    ...
                    : Icon(Icons.settings_input_component_outlined, size: 70, color: primaryBlue.withValues(alpha: 0.5)),
                ),
              ),
              Positioned(
                bottom: 5,
        ...
        _buildSectionHeader('2', 'Shop Details', Icons.store_outlined),
        _buildInputField('Shop Name', 'e.g. Modern Spare Parts', _shopNameController, Icons.shopping_basket_outlined),
        ...
        _buildInputField('About Shop', 'Brief description of inventory...', _descriptionController, Icons.description_outlined, maxLines: 3),
      ],
    );
  }
  ...
  Widget _buildStep2() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('3', 'Inventory Details', Icons.inventory_2_outlined),
        const SizedBox(height: 25),
        _buildLabel('Select Part Categories'),
        const SizedBox(height: 20),
        _buildCheckboxGrid(_partTypes),
        const Padding(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Select Shop Location', style: TextStyle(fontSize: 18, color: Colors.grey.shade800, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 4),
                      Text('Tap to pin your shop on the map', style: TextStyle(fontSize: 14, color: Colors.grey.shade500)),
                    ],
                  ),
                ),
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: ['09:00 AM - 09:00 PM', '10:00 AM - 10:00 PM', '08:00 AM - 05:00 PM', '24 Hours'].map((String value) {
