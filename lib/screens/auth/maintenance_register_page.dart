...
class MaintenanceRegisterPage extends StatefulWidget {
  const MaintenanceRegisterPage({super.key});

  @override
  State<MaintenanceRegisterPage> createState() => _MaintenanceRegisterPageState();
}

class _MaintenanceRegisterPageState extends State<MaintenanceRegisterPage> {
  ...
  Widget _buildStep1() {
    return Column(
      ...
      children: [
              ...
              Container(
                ...
                child: ClipOval(
                  child: _logoImage != null 
                    ...
                    : Icon(Icons.storefront_outlined, size: 70, color: primaryBlue.withValues(alpha: 0.5)),
                ),
              ),
              Positioned(
                bottom: 5,
        ...
        _buildSectionHeader('2', 'Workshop Details', Icons.business_outlined),
        _buildInputField('Workshop Name', 'Enter workshop name', _workshopNameController, Icons.warehouse_outlined),
        ...
        _buildInputField('About Workshop', 'Brief description of services...', _descriptionController, Icons.description_outlined, maxLines: 3),
      ],
    );
  }
  ...
  Widget _buildStep2() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('3', 'Services & Specializations', Icons.settings_suggest_outlined),
        const SizedBox(height: 25),
        _buildLabel('Select Specialties'),
        const SizedBox(height: 20),
        _buildCheckboxGrid(_specialties),
        const Padding(
          padding: EdgeInsets.symmetric(vertical: 25),
          child: Divider(thickness: 1.5),
        ),
        _buildLabel('Supported Brands'),
        const SizedBox(height: 20),
        _buildCheckboxGrid(_brands),
        const Padding(
          padding: EdgeInsets.symmetric(vertical: 25),
          child: Divider(thickness: 1.5),
        ),
        ...
        InkWell(
          onTap: () {
            // Logic to open map picker would go here
          },
          child: Container(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Select Workshop Location', style: TextStyle(fontSize: 18, color: Colors.grey.shade800, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 4),
                      Text('Tap to pin your location on the map', style: TextStyle(fontSize: 14, color: Colors.grey.shade500)),
                    ],
                  ),
                ),
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: ['08:00 AM - 04:00 PM', '09:00 AM - 05:00 PM', '10:00 AM - 08:00 PM', '24 Hours'].map((String value) {
